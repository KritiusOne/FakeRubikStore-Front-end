...
export const SearchBar: React.FC<Props> = ()=>{
  ...
  return (
    <div className="flex flex-row justify-between items-center px-10">
      <ExpandedLogo onClick={()=>handleClickLogo(PUBLIC_ROUTES.HOME)} FillColor="#5A0001" Title="Fake Rubik Store" height="50" width="50" className="flex flex-col-reverse justify-center items-center text-xl text-center text-pretty cursor-pointer text-primaryRed" />
      <nav className="max-w-full h-10 px-10 flex flex-row text-black flex-grow">
