    ...
    <div {...props} className={`w-full flex flex-col justify-center items-center px-2 py-4 gap-2`}>
      ...
      <div className=''>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
          {
            AllProducts.map(product => <article className='w-40 max-h-72 border border-solid border-black flex flex-col justify-center ' key={product.id}>
              ...
              <main className='w-full h-full flex flex-col justify-center items-center px-2 py-1'>
                ...
                <span className='bg-green rounded-xl'>
