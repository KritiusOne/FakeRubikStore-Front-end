...
export const CardCart: React.FC<Props> = ({ id, img, title, cantidad, price }) => {
  ...
  return (
    <article className="flex flex-row justify-center items-center gap-2 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
      ...
      <main className="flex flex-col justify-center items-center gap-0.5">
        ...
        <div className="flex flex-row-reverse gap-2">
          ...
          <span> {cantidad} </span>
          <Button size="small" className="px-[0.3px] py-[0.3px] "> - </Button>
        </div>
        <span> ${price} c/u </span>
      </main>
      <footer className="flex flex-col justify-center items-center"> <IconX />  </footer>
    </article>
  )
}